...
on schedule every 1 second starts current_time on completion preserve
comment 'implementazione cambio stato di un oggetto in asta'
do
begin
	declare var_cf_utente varchar(45);
	declare var_codice_oggetto varchar(45);
    ...
    -- se il numero di offerte è pari a 0 l'oggetto non è stato venduto
